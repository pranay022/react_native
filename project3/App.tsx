...
export default function App() {
  ...
  const generatePasswordString = (passwordLenght: number) => {
    ...
    const lowerCaseChars = 'abcedfghijklmonpqrstuvwxyz';
  ...
  const createPassword = (charecters: string, passwordLenght: number) => {
    let result = '';
      ...
      <SafeAreaView style={styles.appContainer}>
          ...
          <Formik
            ...
            {({
              ...
              <>
                ...
                <View style={styles.inputWrapper}>
                <Text style={styles.heading}>Include Upppercase letters</Text>
                  <BouncyCheckbox 
                  disableBuiltInState
                  isChecked={lowerCase}
        ...
        {isPassGenerated ?(
          <View style={[styles.card, styles.cardElevated]}>
            ...
            <Text style={styles.description}>Log Press to copy</Text>
